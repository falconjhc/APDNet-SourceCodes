...
params = {
    ...
    'num_masks': loader.MultiModalCardiacLoader().num_patho_masks + loader.MultiModalCardiacLoader().num_anato_masks,
    'out_channels': loader.MultiModalCardiacLoader().num_patho_masks + loader.MultiModalCardiacLoader().num_anato_masks + 1,
