import numpy as np
from configuration.multimodalcardiac import unet_config_multimodalcardiac
...
params = {
    'initial_model_path':'/home/hjiang2/Harric/Codes/InitialModels/SDNet-G48-D32-KitsCT/',
    'seed': 1,
    'folder': 'experiment_sdnet_multimodalcardiac-test-Sup-l1-kl-rp-triplet',
    'data_len': 0,
    # 'epochs': 35,
    'batch_size': 8,
    'pool_size': 50,
    ...
    'dataset_name': 'rohan',
    'test_dataset': 'rohan',
    'input_shape': loader.MultiModalCardiacLoader().input_shape,
    'image_downsample': 1,
    'modality': 'LGE',
    ...
    'num_anatomy_masks': loader.MultiModalCardiacLoader().num_anato_masks,
    'out_anatomy_channels': loader.MultiModalCardiacLoader().num_anato_masks + 1,
    'num_pathology_masks': loader.MultiModalCardiacLoader().num_patho_masks,
    'out_pathology_channels': 2,
...
anatomy_encoder_params = copy.copy(unet_config_multimodalcardiac.params)
anatomy_encoder_params['out_channels'] = params['num_mask_channels']
pathology_encoder_params = copy.copy(unet_config_multimodalcardiac.params)
...
def get():
    ...
    params.update({'epochs':unet_config_multimodalcardiac.params['epochs']})
    d_mask_anato_params['input_shape'] = (shp[:-1]) + (loader.MultiModalCardiacLoader().num_anato_masks,)
    d_mask_patho_params['input_shape'] = (shp[:-1]) + (loader.MultiModalCardiacLoader().num_patho_masks,)
