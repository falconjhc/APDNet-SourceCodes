...
class MultiModalCardiacLoader(Loader):
    ...
    def load_labelled_data(self, split, split_type, modality='LGE',
        ...
        if True:
            ...
            np.savez_compressed(os.path.join(self.data_folder, npz_prefix + 'multimodalcardiac_patienet_index'),
                                patient_index)
        ...
        # Load data from saved numpy arrays
            ...
            right_vens = np.load(os.path.join(self.data_folder, npz_prefix + 'multimodalcardiac_right_vens.npz'))[
                'arr_0']
            patient_index = \
            np.load(os.path.join(self.data_folder, npz_prefix + 'multimodalcardiac_patienet_index.npz'))['arr_0']
