...
class Data(object):
    ...
    def __init__(self, images, masks, masknames, index, slice, downsample=1):
        ...
        if images.shape[0] != slice.shape[0]:
            raise ValueError('Different number of images and slices: %d vs %d' % (images.shape[0], slice.shape[0]))
